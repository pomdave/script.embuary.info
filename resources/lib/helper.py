...
#def fengo(params):
    #DIALOG.textviewer(remove_quotes('header', remove_quotes(params.get('message', '')))
    #tmid='ActivateWindow(10025,plugin://plugin.video.fenlight/?mode=extras_menu_choice&amp;tmdb_id=' + remove_quotes(params.get('message', '')) + ')'
    #log(tmid,force=True)
    #execute(tmid)
